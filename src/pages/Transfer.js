			...
			<div className='page-content'>
				<form className='form' onSubmit={checkForm}>
					<div className='input-wrap'>
						...
						<input type='email' value={receiverEmail} onChange={(e) => { inputChange(e, 'receiverEmail') }} />
					</div>

					<div className='input-wrap'>
						<div className='label'>欲轉移平台點數</div>
						<input type='number' min='1' value={amountToTransfer} onChange={(e) => { inputChange(e, 'amountToTransfer') }} />
					</div>
